...
Because number < 100 already returns true or false 
we can immediately return that too to make the function shorter: 
...
It's possible to skip the curly braces for an if statement if you only want one statement to be run after the if. 
...
We can also use a temporary response variable, 
...
// Bonus solution: If you want to round the average you can do that like so: //
